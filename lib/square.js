...
Square.prototype.findSouthWest = function () {
    ...
    var currentSquare = this.board.squares[index];
    var result = false;
    while ((this.board.squares[index].piece.color !== this.board.game.currentPlayer.color) || (index !== null)) {
        if (this.board.squares[index].piece.color === this.board.game.currentPlayer.color) {
            result = true;
        }
        currentSquare = currentSquare.findSouthWest();
...
Square.prototype.findSouth = function () {
    ...
    while ((this.board.squares[index].piece.color !== this.board.game.currentPlayer.color) || (index !== null)) {
        ...
        currentSquare = currentSquare.findSouth();
        console.log(currentSquare);
    }
    return result;
};

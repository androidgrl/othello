...
Board.prototype.findValidSquares = function() {
    ...
    var squaresWithNeighborHavingPieceOfOppositeColor = emptySquares.filter(function(square){
        return square.hasNeighborWithPieceOfOppositeColor();
    });
    ...
    return squaresWithNeighborHavingPieceOfOppositeColor;
};
